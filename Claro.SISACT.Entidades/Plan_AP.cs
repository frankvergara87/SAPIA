...
{
	/// <summary>
	/// Descripción breve de Plan_AP.
	/// </summary>
	public class Plan_AP
	{
		...
		public Paquete_AP PAQUETE {get{ return _PAQUETE;} set{_PAQUETE = value;}}
		...
		public double CARGO_FIJO_TOTAL
		{
			get
			{
				...
				foreach (Servicio_AP oServ in SERVICIOS)
				{
					
					if (PAQUETE.PAQTV_CODIGO != string.Empty && PAQUETE.PAQTV_CODIGO != "00")
					{
						if ((Funciones.CheckInt64(oServ.SELECCIONABLE_EN_PAQUETE) &
							(Funciones.CheckInt64(SERVICIOS_SELECCIONABLE.SELECCIONADO) | Funciones.CheckInt64(SERVICIOS_SELECCIONABLE.OBLIGATORIO))) != 0)
						{
					...
					{
						if ((Funciones.CheckInt64(oServ.SELECCIONABLE_EN_PLAN) &
							(Funciones.CheckInt64(SERVICIOS_SELECCIONABLE.SELECCIONADO) | Funciones.CheckInt64(SERVICIOS_SELECCIONABLE.OBLIGATORIO))) != 0)
						{
