...
{
	/// <summary>
	/// Summary description for SolicitudEmpresa.
	/// </summary>
	public class SolicitudEmpresa
	{
		...
		private ArrayList _REPRESENTANTE_LEGAL;
		...
		private double _SOLIN_SUM_CAR_CON = 0.0;
		 ...
		 //-- E75810 - Despacho
		private SolPersona _CONTACTO1;
		private SolPersona _CONTACTO2;
		private SolDireccion _DIR_DESPACHO;
		//--
		private SolDireccion _DIR_FACTURACION;
		private SolDireccion _DIR_FISCAL;
		private SolPersona _CONTACTO_FACT;
		private ArrayList _DETALLE_BOLSAS;
		private string _FECHA_ACTIVACION;
		private string _ID_TIPO_OPERACION;
		private string _DES_TIPO_OPERACION;
		private string _APN;
		private string _FLG_AMP_BOL_MIN;
		private string _FLG_AMP_BOL_SRV;
		private Int32 _CICLO;
		private string _DES_CICLO;
		...
		private string _SOLIV_FACTOR_RENOVACION;
		...
		public ArrayList REPRESENTANTE_LEGAL
		{
		...
		//-- E75810 - Despacho
		public SolPersona CONTACTO1
		{
			get { return _CONTACTO1; }
			set { _CONTACTO1 = value;  }
		}

		public SolPersona CONTACTO2
		{
			get { return _CONTACTO2; }
			set { _CONTACTO2 = value;  }
		}

		public SolDireccion DIR_DESPACHO
		{
			get { return _DIR_DESPACHO; }
			set { _DIR_DESPACHO = value; }
		}
		//--Fin
		public SolDireccion DIR_FACTURACION
		{
			get { return _DIR_FACTURACION; }
			set { _DIR_FACTURACION = value; }
		}
		public SolDireccion DIR_FISCAL
		{
			get { return _DIR_FISCAL; }
			set { _DIR_FISCAL = value; }
		}

		public SolPersona CONTACTO_FACT
		{
			get { return _CONTACTO_FACT; }
			set { _CONTACTO_FACT = value;  }
		}
		...
		public string ID_TIPO_OPERACION
		{
			...
			set{ _ID_TIPO_OPERACION= value;}
		}

		public string DES_TIPO_OPERACION
		{
			get{ return _DES_TIPO_OPERACION;}
			set{ _DES_TIPO_OPERACION= value;}
		}

		public string FLG_AMP_BOL_MIN
		{
			get{ return _FLG_AMP_BOL_MIN;}
			set{ _FLG_AMP_BOL_MIN= value;}
		}

		public string FLG_AMP_BOL_SRV
		{
			get{ return _FLG_AMP_BOL_SRV;}
			set{ _FLG_AMP_BOL_SRV= value;}
		}
		...
		public string DES_CICLO
		{
			get{ return _DES_CICLO;}
			set{ _DES_CICLO= value;}
		}
		...
		public string SOLIV_FACTOR_RENOVACION
		{
			get{ return _SOLIV_FACTOR_RENOVACION;}
			set{ _SOLIV_FACTOR_RENOVACION = value; }
		}
