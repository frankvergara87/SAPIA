<%@ Page Language="vb" AutoEventWireup="false" Codebehind="sisact_ifr_consulta_lista_precios_ICCID.aspx.vb" Inherits="sisact_ifr_consulta_lista_precios_ICCID"%>
	...
	<script language="javascript">
			function inicio() {
				...
				if (getValue('hidResponse') == "RetornarDatos") { 
					...
					if (window.parent) {
						window.parent.responseConsultarListaPreciosDAC_CAD(getValue('hidDatosRetorno'));
					}
				}
			}
