<%@ Page Language="vb" AutoEventWireup="false" Codebehind="sisact_ifr_consulta_IMEI_Postpago.aspx.vb" Inherits="sisact_ifr_consulta_IMEI_Postpago"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
  <head>
    <title>sisact_ifr_consulta_IMEI</title>
		...
		<script language="javascript">
			function inicio() {
				...
				if (getValue('hidResponse') == "RetornarDatosCAC") { 
					if (window.parent) {
						window.parent.responseConsultarIMEICAC(getValue('hidDatosRetorno'));
					}
				}
			}		
	...
	<body MS_POSITIONING="GridLayout" onload="javascript:inicio();">
		<form id="frmPrincipal" method="post" runat="server">
			<input id="hidCodIccid" type="hidden" name="hidCodIccid" runat="server" style="WIDTH: 16px; HEIGHT: 22px" size="1">
			...
			<input id="hidNroLinea" type="hidden" name="hidNroLinea" runat="server" style="WIDTH: 16px; HEIGHT: 22px" size="1">
		</form>
	</body>
