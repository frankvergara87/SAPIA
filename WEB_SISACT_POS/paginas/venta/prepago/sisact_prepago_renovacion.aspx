<%@ Page Language="vb" AutoEventWireup="false" Codebehind="sisact_prepago_renovacion.aspx.vb" Inherits="sisact_prepago_renovacion" %>
			...
			//debugger;
				switch (pasoActual) {
					case 1:
						...
						/*if (document.getElementById('ifrOperador149').src != "") {
							document.getElementById('ifrOperador149').contentWindow.location = "../sisact_ifr_operador149.aspx";
						}*/
						...
						//}
						//alert("muestra el canal, pdv y vendedor..")
						break;
					case 2:
						// Cargar Iframe de Busqueda Prepago
						/*if (document.getElementById('ifrBusquedaPrepago').src != "") {
							document.getElementById('ifrBusquedaPrepago').contentWindow.location = "sisact_ifr_busqueda_prepago.aspx";
						}*/
					...
					case 3:
						...
						/*if (document.getElementById('ifrDetalleCliente').src != "") {
							document.getElementById('ifrDetalleCliente').contentWindow.location = "sisact_ifr_detalle_cliente.aspx";
						}*/
					...
					case 4:
						...
						/*if (document.getElementById('ifrDetalleVenta').src != "") {
							document.getElementById('ifrDetalleVenta').contentWindow.location = "sisact_ifr_venta_prepago.aspx";
						}*/
