...
<HTML>
  <HEAD>
		...
		<script language="javascript" type="text/javascript">
			...
			function f_ModificarDetallePlan(cod)
			{
			//alert(cod);
				
					setValue('hidCodigo',cod);
					__doPostBack('btnModificarDetallePlan','');				
			}
			...
			function f_mostrarPestaña(ind){
				...
				if(ind == 1) //Campanias
				{
					...
					document.getElementById("tdCampanias").bgColor="#325493";
				...
				else if(ind == 2) //Puntos de Venta
				{
					...
					document.getElementById("tdPDV").bgColor="#325493";
											...
											<td>
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													...
													<tr>
														...
														<td style="HEIGHT: 26px">&nbsp;<asp:dropdownlist id="ddlBusqueda" onchange=" f_InactivarTxtLista();" CssClass="clsSelectEnable" Width="100px"
																Runat="server">
															...
															&nbsp;<asp:textbox onpaste="return false" id="txtBusDescripcion" onkeydown="javascript:f_ValidarEnter();"
																runat="server" CssClass="clsInputEnable" Width="200px" MaxLength="50"></asp:textbox>
													...
													<tr>
														...
														<td style="HEIGHT: 26px">&nbsp;<asp:dropdownlist id="ddlEstadoListado" onchange=" f_InactivarTxtLista();" CssClass="clsSelectEnable"
							...
							<tr id="trGrilla">
								<td>
									<table cellSpacing="0" cellPadding="0" width="600" border="0">
										<tr>
											<td><asp:datagrid id="dgrGrillaCabecera" runat="server" Width="1210px" showheader="True" autogeneratecolumns="False">
													<columns>
 ...
 runat="server"></asp:CheckBox>
									...
									<div class="clsGridRow" id="divGrillaDetalle" style="WIDTH: 984px; HEIGHT: 374px">
										<table cellSpacing="0" cellPadding="0" width="600" border="0">
											<tr>
												<td><asp:datagrid id="dgrGrillaDetalle" runat="server" showheader="True" autogeneratecolumns="False"
														AllowPaging="True">
														...
														<columns>
															...
															<asp:boundcolumn datafield="LISTA_DOCUMENTO" itemstyle-cssclass="Arial10B" HeaderText="TIPO_DOCUMENTO">
																<headerstyle horizontalalign="Center" cssclass="TablaTitulos"></headerstyle>
															...
															<asp:boundcolumn datafield="TOPE_CONSUMO_SIN_CF" itemstyle-cssclass="Arial10B" HeaderText="TOPE SIN CF">
																<headerstyle horizontalalign="Center" cssclass="TablaTitulos"></headerstyle>
																<itemstyle wrap="False" width="100px"></itemstyle>
															</asp:boundcolumn>
															<asp:boundcolumn datafield="TOPE_CONSUMO_CON_CF" itemstyle-cssclass="Arial10B" HeaderText="TOPE CON CF">
																<headerstyle horizontalalign="Center" cssclass="TablaTitulos"></headerstyle>
																<itemstyle wrap="False" width="100px"></itemstyle>
															</asp:boundcolumn>
															<asp:boundcolumn datafield="TOPE_CONSUMO_AUTOM" itemstyle-cssclass="Arial10B" HeaderText="TOPE AUTOM">
																<headerstyle horizontalalign="Center" cssclass="TablaTitulos"></headerstyle>
																<itemstyle wrap="False" width="100px"></itemstyle>
															</asp:boundcolumn>
														...
														onmouseout="this.className='Boton';" CssClass="Boton" Width="90" Runat="server" Text="Eliminar" Height="19"
														Visible="False"></asp:button><asp:button id="btnExportar" onmouseover="this.className='BotonResaltado';" style="CURSOR: hand"
														onmouseout="this.className='Boton';" CssClass="Boton" Width="90" Runat="server" Text="Exportar" Height="19" Visible="False"></asp:button></td>
											</tr>
										</table>
									</div>
								</td>
							...
							<tr id="trEdicion" width="100%">
								<td>
									<table cellSpacing="0" cellPadding="1" width="790" border="0">
										<tr>
										...
										<TR> <!--Codigo Del Plan Sisact-->
											...
											<TD class="Arial10B" style="WIDTH: 400px"><asp:textbox onkeypress="validaCaracterPlan();" onpaste="return false" id="txtCodPlanSisact"
										...
										<TR> <!--Descripción Plan-->
											...
											<TD class="Arial10B" style="WIDTH: 5px">:</TD>
											<TD class="Arial10B" style="WIDTH: 400px"><asp:textbox onkeypress="validaCaracteres();" onpaste="return false" id="txtDesPlanSisact" runat="server"
													MaxLength="40" width="300px" cssclass="clsInputEnable"></asp:textbox></TD>
											<TD class="Arial10B" colSpan="2"></TD>
										</TR>
										<TR> <!--Descripción Plan-->
											<TD class="Arial10B" style="WIDTH: 200px">&nbsp;Tipo Documento (*)</TD>
											<TD class="Arial10B" style="WIDTH: 5px">:</TD>
											<TD class="Arial10B" style="WIDTH: 400px">
												<asp:checkboxlist id="ctlTipoDocumento" runat="server" CssClass="Arial11BV" Width="576px" Height="8px"
										...
										<TR> <!--Código Plan SAP-->
											...
											<TD class="Arial10B" style="WIDTH: 5px">:</TD>
											<TD class="Arial10B" style="WIDTH: 400px"><asp:textbox onkeypress="validaCaracterPlan();" onpaste="return false" id="txtCodPlanSAP"
										...
										<TR> <!--Código Plan BSCS-->
											...
											<TD class="Arial10B" style="WIDTH: 5px">:</TD>
											<TD class="Arial10B" style="WIDTH: 400px"><asp:textbox onkeypress="f_EventoSoloNumerosEnteros();" onpaste="return false" id="txtCodPlanBSCS"
										...
										<TR> <!--Descripción Plan Base-->
											...
											<TD class="Arial10B" style="WIDTH: 5px">:</TD>
											<TD class="Arial10B" style="WIDTH: 400px"><asp:textbox onkeypress="validaCaracteres();" onpaste="return false" id="txtDesPlanBase" runat="server"
													MaxLength="40" width="300px" cssclass="clsInputEnable"></asp:textbox></TD>
											<TD class="Arial10B" colSpan="2"></TD>
										</TR>
										<tr> <!--Estado-->
										...
										<TR> <!-- Tipo de Flujo --Alta/Portabilidad-->
											<TD class="Arial10B" style="WIDTH: 200px">&nbsp;Tipo Flujo&nbsp;(*)</TD>
											<TD class="Arial10B" style="WIDTH: 5px">:</TD>
										...
										<TR> <!-- Grupo de plan -->
											...
											<TD class="Arial10B" style="WIDTH: 5px">:</TD>
											<TD class="Arial10B" style="WIDTH: 400px"><asp:dropdownlist id="ddlGrupoPlan" runat="server" width="160px" cssclass="clsSelectEnable"></asp:dropdownlist><INPUT class="Boton" id="btnAgregarGrupo" onclick="cargarPopUpGrupo();" type="button" value="Agregar"
										...
										<TR> <!--Flag Renovacion-->
											<TD class="Arial10B" style="WIDTH: 200px">&nbsp;Flag de Renovación (*)</TD>
											<TD class="Arial10B" style="WIDTH: 5px">:</TD>
											<TD class="Arial10B" style="WIDTH: 400px"><asp:checkbox id="chkFlagRenovacion" runat="server"></asp:checkbox></TD>
											<TD class="Arial10B" colSpan="2"></TD>
										</TR>
										<tr id="trPestanas" runat="server">
											<td colSpan="7"><br>
												<table borderColor="#f48d29" cellSpacing="1" cellPadding="1" width="100%" align="center"
													border="1">
													<tr width="100%">
														<td class="Arial11BV" id="tdCampanias" style="PADDING-LEFT: 15px; CURSOR: hand; COLOR: white"
															onclick="f_mostrarPestaña(1);" align="center" width="25%"  bgColor="#325493">
														...
														<td class="Arial11BV" id="tdPDV" style="CURSOR: hand" onclick="f_mostrarPestaña(2);"
															align="center" width="25%" bgColor="#f59130"><FONT color="#ffffff" size="2"><STRONG>Restricción 
																	Plazo de acuerdo / Cuota</STRONG> </FONT>
														</td>
													</tr>
												</table>
											</td>
										...
										<tr id="trPDV">
											<TD class="Arial10B" colSpan="5" height="25">
												<TABLE id="tblPDV" style="BORDER-COLLAPSE: collapse" borderColor="#95b7f3" cellSpacing="0"
													...
													<TR>
														<TD class="header" borderColor="#ffffff" align="center" height="20">Restricción PDV
														</TD>
													</TR>
													<TR>
													...
													<TR id="trBusquedaPdv" runat="server">
														<TD class="Arial11BV" style="HEIGHT: 9px"><INPUT class="Boton" id="btnAgregarPDV" onclick="cargarPopUpPdv();" type="button" value="Agregar"
																name="btnAgregarPDV">
															<asp:button id="btnEliminarItemsPdv" onmouseover="this.className='BotonResaltado';" style="CURSOR: hand"
																onmouseout="this.className='Boton';" CssClass="Boton" Width="126" Runat="server" Text="Eliminar Todos"
																Height="19"></asp:button></TD>
													</TR>
																	...
																	<asp:templatecolumn headertext="" headerstyle-width="25px" itemstyle-width="25px">
																		...
																		<itemtemplate>
																			<a href='javascript:f_EliminarPDV("<%# DataBinder.Eval(Container.DataItem, "OVENC_CODIGO")%>");'>
																				<img src="../../images/ico_Eliminar.gif" border="0" alt='Eliminar Configuración'></a>
																		</itemtemplate>
																	</asp:templatecolumn>
										...
										<tr id="trDetalle">
											<TD class="Arial10B" colSpan="5" height="25">
												<TABLE id="TblDetalle" style="BORDER-COLLAPSE: collapse" borderColor="#95b7f3" cellSpacing="0"
													cellPadding="0" width="616" align="center" border="1">
													<TR>
														<TD class="header" borderColor="#ffffff" align="center" height="20">Restricción 
															Plazo de acuerdo / Cuota
														</TD>
													</TR>
													<TR>
														<TD borderColor="#ffffff" colSpan="2"><IMG height="3" alt="" src="../../images/spacer.gif" width="2" border="0"></TD>
													...
													<TR id="Tr3" runat="server">
														<TD class="Arial11BV" style="HEIGHT: 9px"><INPUT class="Boton" id="btnAgregarDetallePlan" onclick="cargarPopUpDetalle();" type="button"
															...
															<asp:button id="btnEliminarItemsDetalle" onmouseover="this.className='BotonResaltado';" style="CURSOR: hand"
																onmouseout="this.className='Boton';" CssClass="Boton" Width="126" Runat="server" Text="Eliminar Todos"
																Height="19"></asp:button></TD>
													</TR>
														...
														<TD><asp:datagrid id="dgDetallePlan" runat="server" Width="100%" AllowPaging="True" CellSpacing="2"
																...
																<Columns>
																	...
																	<asp:templatecolumn headertext="" headerstyle-width="25px" itemstyle-width="25px">
																		<itemstyle horizontalalign="Center"></itemstyle>
																		<itemtemplate>
																			<a href='javascript:f_ModificarDetallePlan("<%# DataBinder.Eval(Container.DataItem, "IdDocumento")%>,<%# DataBinder.Eval(Container.DataItem, "IdPlazo")%>,<%# DataBinder.Eval(Container.DataItem, "IdCuota")%>,<%# DataBinder.Eval(Container.DataItem, "ValorCuota")%>");'>
																				<img src="../../images/btn_edit.jpg" border="0" alt='Modificar Configuración'></a>
																		</itemtemplate>
																	</asp:templatecolumn>
																</Columns>
																<PagerStyle Font-Size="12px" Mode="NumericPages"></PagerStyle>
			...
			<input id="btnEliminarCanal" style="DISPLAY: none" type="button" name="btnEliminarCanal"
				runat="server"> <input id="btnEliminarDetallePlan" style="DISPLAY: none" type="button" name="btnEliminarDetallePlan"
				runat="server">&nbsp; <input id="btnModificarDetallePlan" style="DISPLAY: none" type="button" name="btnModificarDetallePlan"
				runat="server"><input id="hidCodigo" style="WIDTH: 123px; HEIGHT: 22px" type="hidden" size="15" name="hidCodigo"
				runat="server"> <input id="hidCargaInicial" style="WIDTH: 123px; HEIGHT: 22px" type="hidden" size="15"
				name="hidCargaInicial" runat="server"> <input id="hidCondicion" style="WIDTH: 123px; HEIGHT: 22px" type="hidden" size="15" name="hidCondicion"
				runat="server"> <input id="btnEliminarTodosDetallePlan" style="DISPLAY: none" type="button" name="btnEliminarTodosDetallePlan"
				runat="server">
		</form>
	</body>
</HTML>
