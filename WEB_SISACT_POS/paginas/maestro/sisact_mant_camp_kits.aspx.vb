...
#End Region
    ...
    Private Sub btnEliminar_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.ServerClick
        ...
        Dim resultado As Boolean
            ...
            Auditoria(ConfigurationSettings.AppSettings("codTrsMantCampKitDTH_Eliminar"), "Eliminar Campaña Kit DTH")
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        Try
            ...
            If hidCodigo.Value.Length = 0 Then
                ...
                Auditoria(ConfigurationSettings.AppSettings("codTrsMantCampKitDTH_Insertar"), "Insertar Campaña Kit DTH")
            Else
                objLCampanaKit.fbooModificar(hidCodigo.Value, strPrecio, strInstal, strCFAlquilerKit, _
                    strUsuario, curSalida, Msg)
                Auditoria(ConfigurationSettings.AppSettings("codTrsMantCampKitDTH_Modificar"), "Modificar Campaña Kit DTH")
            End If
        ...
        Catch ex As Exception
            ...
            ElseIf ex.Message.IndexOf("ORA-20660") > -1 Then
                RegisterStartupScript("script1", "<script>f_MostrarTab('EDICION');alert('Error: El código del kit de campaña ya existe.')</script>")
            Else
                Throw ex
            End If
    ...
    Private Sub Buscar()
        ...
        Dim strDescripcion As String
            ...
            If ddlBusqueda.SelectedValue <> "0" OrElse strDescripcion.Length > 0 Then
                ...
                dgrGrillaDetalle.DataBind()
            End If
            Auditoria(ConfigurationSettings.AppSettings("codTrsMantCampKitDTH_Consulta"), "Consulta Campaña Kit DTH")
            RegisterStartupScript("script", "<script>f_MostrarTab('BUSQUEDA')</script>")
