...
Public Class sisact_pop_cargarPdv2
...
#End Region
    ...
    Dim CE_ESTADO_PDV As Integer = Funciones.CheckInt(ConfigurationSettings.AppSettings("CE_ESTADO_PDV"))
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            cltCanal.DataSource = obj.ListarTipoOficina(CE_ESTADO_PDV) ' objLRestriccionPDV.fdtbListarTipoOficina
            cltCanal.DataBind()
    ...
    Private Sub BuscarPDV()
        ...
        For Each lit As ListItem In cltCanal.Items
            ...
            End If
        Next
        oArray = obj.ListarPDV(strCanales, CE_ESTADO_PDV, strCodigo, strDescripcion)
    ...
    Private Sub btnAgregarPdv_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregarPdv.Click
        ...
        If Not Session("oArrayListSessionPdv") Is Nothing Then ' Testing
            ...
            Dim Arreglo As ArrayList = Session("oArrayListSessionPdv")
            Dim Dt As DataTable = Session("PDV")
            Dt.Rows.Clear()
            For Each Item As Claro.SisAct.Entidades.PuntoVenta In Arreglo
                Dim Fila As DataRow = Dt.NewRow
                Fila("IdPuntoVenta") = Convert.ToString(Item.OVENC_CODIGO)
                Fila("PuntoVenta") = Convert.ToString(Item.OVENV_DESCRIPCION)
                Fila("Canal") = Convert.ToString(Item.CANAC_CODIGO)
                Dt.Rows.Add(Fila)
            Next
            Session("PDV") = Dt
    ...
    Private Sub btnCargarSesion_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCargarSesion.ServerClick
        ...
        If Me.hidCondicion.Value = "TODOS" Then
            ...
            For Each lit As ListItem In cltCanal.Items
                ...
                End If
            Next
            Session("oArrayListSessionPdv") = obj.ListarPDV(strCanales, CE_ESTADO_PDV, strCodigo, strDescripcion)
        Else
