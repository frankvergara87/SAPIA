<%@ Page Language="vb" AutoEventWireup="false" Codebehind="sisact_pop_cargarPdv.aspx.vb" Inherits="sisact_pop_cargarPdv" %>
										...
										<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
											<tr>
												...
												<td class="Arial11BV" noWrap>
													...
													<asp:textbox id="txtBusquedaCodPdv" onPaste="return false" onkeypress="validaCaracteres();" runat="server"
														Enabled="false" CssClass="clsInputEnable" Width="80px"></asp:textbox>
												</td>
											</tr>
											<TR>
											...
											<TR>
												...
												<TD class="Arial11BV" noWrap>
													...
													<asp:textbox id="txtDescripcionPdv" onPaste="return false" onkeypress="validaCaracteres();" runat="server"
														Enabled="false" CssClass="clsInputEnable" Width="184px"></asp:textbox>
												</TD>
											</TR>
											<TR>
												<TD class="Arial11BV"></TD>
							...
							<tr align="center">
								<td colSpan="2" height="30">
									<asp:button id="btnAgregarPdv" onmouseover="this.className='BotonResaltado';" onmouseout="this.className='Boton';"
										...
										onmouseout="this.className='Boton';" type="button" value="Cancelar" runat="server">
								</td>
							</tr>
						</table>
